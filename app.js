 ...
 */ !(function (t) {
        ...
        j = f(function (e) {
          ...
          function u(t) {
            ...
            this.timer && this.timer.destroy(),
              ...
              "string" == typeof t
                ? ((e = {})[t] = 1)
                : (e = "object" == r(t) && null != t ? t : this.props),
              p.call(this, e, v),
              d.call(this);
          }
          function f() {
  ...
  function (t, e, n) {
    ...
    function it(t, e) {
      ...
      if (
        (ut({ store: e, rawData: l, allowEvents: a, testManual: c }),
        (r && n === E.ActionTypeConsts.GENERAL_START_ACTION) || T(n))
      ) {
        gt({ store: e, actionListId: r }),
          ht({ store: e, actionListId: r, eventId: o });
        var p = yt({
          store: e,
          eventId: o,
          actionListId: r,
    ...
    function ot(t, e) {
      ...
      n ? gt({ store: e, actionListId: n }) : Et({ store: e }), ct(e);
    }
    function at(t, e) {
      ct(e), F({ store: e, elementApi: _ });
    }
    function ut(t) {
      var e,
        n = t.store,
                        ...
                        if ((0, f.default)(d)) {
                          (0, v.default)(d, function (t, e) {
                            ...
                            (a.actionTypeId ===
                              ...
                              T(a.actionTypeId)) &&
                              ht({ store: n, actionListId: v, eventId: f });
                          });
                          var p = function (t) {
                              var e = n.getState(),
                                r = e.ixSession;
    ...
    function ct(t) {
      ...
      e.active &&
        (e.eventListeners.forEach(st), t.dispatch((0, y.sessionStopped)()));
    }
    function st(t) {
      var e = t.target,
        n = t.listenerParams;
      ...
      if (f && f.useFirstGroupAsInitialState) {
        ...
        l.forEach(function (t) {
          ...
          s.forEach(function (i) {
            var o = f ? $(a)(i, t) : null;
            _t({
              destination: M({ element: i, actionItem: t, elementApi: _ }, o),
              immediate: !0,
              store: e,
              element: i,
              eventId: r,
          ...
          if (p) {
            ...
            C({
              ...
              var E = S === e && 0 === p,
                ...
                y = M({ element: u, actionItem: t, elementApi: _ }, v);
              _t({
                store: n,
                element: u,
                actionItem: t,
    ...
    function _t(t) {
      var e,
        ...
        A = (b[w] || {}).refState,
        S = _.getRefType(c),
        x = T.reducedMotion && E.ReducedMotionTypes[s.actionTypeId];
      if (x && d)
        switch (
      ...
      r.dispatch(
        ...
        It(document.body, "ix2-animation-started", g),
        f
          ? (function (t, e) {
          ...
          : (P({
            ...
            h && r.dispatch((0, y.instanceStarted)(g, T.tick)));
    }
    function mt(t, e) {
          ...
          var n = function (t) {
            ...
            i = function (t) {
              if (void 0 === t || t instanceof Event)
                ...
                if ("object" !== r(t) || !t.length || !t[0].nodeName) return !1;
                t = t;
              }
  ...
  function (t, e, n) {
    var r = n(12)(n(5), "DataView");
    t.exports = r;
  },
  function (t, e, n) {
    var r = n(12)(n(5), "Promise");
    t.exports = r;
  },
  function (t, e, n) {
    var r = n(12)(n(5), "Set");
  ...
  function (t, e, n) {
    ...
    Object.defineProperty(e, "__esModule", { value: !0 }),
        ...
        switch (n.actionTypeId) {
          ...
          case ot:
            var c = r.getStyle,
              ...
              h = v.widthValue,
              y = v.heightValue;
            if (!g.IS_BROWSER_ENV) return { widthValue: h, heightValue: y };
            if (d === W) {
              var _ = c(e, L);
              s(e, L, ""), (h = f(e, "offsetWidth")), s(e, L, _);
            }
            if (p === W) {
              var m = c(e, M);
              s(e, M, ""), (y = f(e, "offsetHeight")), s(e, M, m);
            }
            return { widthValue: h, heightValue: y };
          case at:
          case ut:
          case ct:
            var I = n.config,
      ...
      (e.getInstanceOrigin = function (t) {
        ...
        switch (r.actionTypeId) {
          ...
          case tt:
          case et:
            return e[r.actionTypeId] || At[r.actionTypeId];
          case rt:
              ...
              (a =
                r.config.widthUnit === W
                  ? mt.test(c)
                    ? parseFloat(c)
                    : parseFloat(n.width)
                  : (0, s.default)(parseFloat(c), parseFloat(n.width))),
              (u =
      ...
      (e.reduceListToGroup = function (t) {
        var e = t.actionList,
          ...
          c = function (t) {
            return (
              a.push((0, d.mergeIn)(t, ["config"], { delay: 0, duration: 0 })),
              t.id === n
            );
          };
        return (
          ...
          (0, d.setIn)(
            r,
            ["actionLists"],
            u({}, e.id, { id: e.id, actionItemGroups: [{ actionItems: a }] })
          )
        );
      }),
            ...
            return (function (t, e, n, r, i) {
              ...
              Mt(t, g.TRANSFORM_PREFIXED, i),
                ...
                ((s === Z && void 0 !== d) ||
                  ...
                  a(t, g.TRANSFORM_STYLE_PREFIXED, S);
              var u, c, s, f, l, d;
            })(t, e, n, i, a);
          case Q:
      ...
      (e.shouldNamespaceEventParameter = function (t, e) {
        var n = e.basedOn;
        return (
          (t === p.EventTypeConsts.SCROLLING_IN_VIEW &&
            (n === p.EventBasedOn.ELEMENT || null == n)) ||
          (t === p.EventTypeConsts.MOUSE_MOVE && n === p.EventBasedOn.ELEMENT)
        );
      }),
    ...
    function _t(t) {
      ...
      var I = yt(m),
        ...
        A = I.appliesTo,
        S = I.useEventTarget;
      if (T) return [vt[T] || (vt[T] = {})];
      if (A === p.EventAppliesTo.PAGE) {
        var x = f(b);
        return x ? [x] : [];
      }
      var R,
    ...
    var At =
        (u((o = {}), Z, Object.freeze({ xValue: 0, yValue: 0, zValue: 0 })),
        u(o, J, Object.freeze({ xValue: 1, yValue: 1, zValue: 1 })),
        u(o, tt, Object.freeze({ xValue: 0, yValue: 0, zValue: 0 })),
        u(o, et, Object.freeze({ xValue: 0, yValue: 0 })),
        o),
      St = Object.freeze({
        blur: 0,
        "hue-rotate": 0,
    ...
    function jt(t) {
      ...
      e.actionItems.forEach(function (t) {
        ...
        (e = (0, E.isPluginType)(i)
          ? (0, E.clearPlugin)(i)
          : Ft({ effect: kt, actionTypeId: i, elementApi: r })),
  ...
  function (t, e, n) {
    ...
    var u,
      ...
      X = y.PAGE_FINISH,
      G = y.ECOMMERCE_CART_CLOSE,
      V = y.ECOMMERCE_CART_OPEN,
      U = y.PAGE_START,
      W = y.PAGE_SCROLL,
      B = "COMPONENT_ACTIVE",
      H = "COMPONENT_INACTIVE",
      z = v.IX2EngineConstants.COLON_DELIMITER,
      ...
      et = { handler: tt($, J) },
      nt = (0, f.default)({}, et, { types: [B, H].join(" ") }),
      rt = [
        ...
        function () {
          return {
            ...
            stiffScrollTop: (0, p.default)(
              u ? window.pageYOffset : c.scrollTop,
              0,
              c.scrollHeight - window.innerHeight
            ),
      ...
      st = function (t) {
        return function (e, n) {
          var r = e.nativeEvent.type,
            i = -1 !== [B, H].indexOf(r) ? r === B : n.isActive,
      ...
      Et =
        ...
        i(r, R, pt()),
        i(r, N, vt()),
        i(r, V, { types: "ecommerce-cart-open", handler: tt($, J) }),
        i(r, G, { types: "ecommerce-cart-close", handler: tt($, J) }),
        i(r, _, {
          types: "click",
          handler: tt(
            $,
        ...
        i(r, I, (0, f.default)({}, et, { types: "mousedown" })),
        i(r, b, (0, f.default)({}, et, { types: "mouseup" })),
        i(r, T, {
        ...
        i(r, M, {
          ...
          handler: function (t) {
            ...
            return (
              ...
              (u !== v.EventBasedOn.ELEMENT || S || S !== a.elementHovered) &&
                ((w = f ? 1 - w : w),
                e.dispatch((0, E.parameterChanged)(A, w))),
              { elementHovered: S, clientX: h, clientY: y, pageX: m, pageY: b }
            );
          },
        }),
        i(r, W, {
        ...
        i(r, k, {
          ...
          handler: function (t) {
            ...
            if (d === v.EventBasedOn.VIEWPORT) {
              ...
              return (
                A !== o.scrollPercent &&
                  n.dispatch((0, E.parameterChanged)(h, A)),
                { scrollPercent: A }
              );
            }
            var S = Y(i, h),
    ...
    r.define(
      ...
      (t.exports = function (t, e) {
        ...
        function D(e) {
          ...
          var s = e.index;
          s >= n && (s = n - 1), M(e, { immediate: !0, index: s });
        }
        return (
          (s.ready = function () {
            (u = r.env("design")), _();
...
Webflow.require("ix2").init({
  events: {
    e: {
      ...
      target: {
        id: "b328152c-244f-b037-6056-ea1cc5a45426",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-5": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6401ed150a210b770700a87c|8d9bd7df-dfd5-dc3f-23e1-b3bd742752d3",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-21": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6403513a27be9bdd11b58d4e|95b97192-c778-b05c-7226-4a96e7a866f9",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-23": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6401ed150a210b770700a87c|c9dd513b-8058-1be7-e8d0-58a8bd5fe658",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-27": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6403513a27be9bdd11b58d4e|c1215f7e-320d-a7a7-0a42-cce59303fecd",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-29": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "6401ed150a210b770700a87c|657356b5-72d5-e355-8845-a14f736c7064",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
  ...
  actionLists: {
    a: {
          ...
          actionItems: [
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selector: ".text-block_btn",
                  selectorGuids: ["e4030278-98a5-72b0-5e59-b7273263581f"],
                },
                globalSwatchId: "29a59a12",
                rValue: 243,
                bValue: 20,
                gValue: 255,
                aValue: 1,
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  useEventTarget: "CHILDREN",
                  selector: ".speed_on-top",
                  selectorGuids: ["17205e60-52d7-77df-c723-592aa08db7d4"],
                },
                value: 0,
                unit: "",
              },
      ...
      createdOn: 1677854811551,
    },
    "a-2": {
      id: "a-2",
      title: "out_speedmeter_animation",
      actionItemGroups: [
        {
          actionItems: [
            {
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                duration: 0,
                target: {
                  id: "6401ed150a210b770700a87c|32410867-ff7c-f70b-3d4e-44a3a36e12b2",
                },
                value: "flex",
              },
            },
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                duration: 1000,
                target: {
                  id: "6401ed150a210b770700a87c|dc0f2acc-ad5a-d8fd-ec81-53cf102ded8b",
                },
                value: 0,
                unit: "",
              },
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                easing: "outQuad",
                duration: 330,
                target: { id: "169c3c7c-3547-50ab-46fd-100ce6b0949e" },
                yValue: 0,
                xUnit: "PX",
                yUnit: "%",
                zUnit: "PX",
    ...
    "a-4": {
      ...
      useFirstGroupAsInitialState: false,
      createdOn: 1678460054607,
    },
    "a-9": {
      id: "a-9",
      title: "in_speedmeter_animation 3",
      actionItemGroups: [
        {
          actionItems: [
            {
    ...
    "a-10": {
      id: "a-10",
      title: "out_speedmeter_animation 3",
      actionItemGroups: [
        {
          actionItems: [
            {
